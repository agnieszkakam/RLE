...
HD_PWD='C:/git/RLE/src/RLE.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_noFIFO.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_noFIFO.tcl -notrace
